...
DESCRIÇÃO EM 1 FRASE: Camada de orquestração inteligente para Qwen CLI que automatiza o ciclo Plan-Code-Verify via Git Worktrees isolados.

STACK TECNOLÓGICA:
  Frontend: N/A (CLI Extension)
  Backend: Node.js (v22+) + Qwen CLI Extension API
...
RESTRIÇÕES CONHECIDAS: 
  - Deve rodar como extensão do Qwen CLI.
